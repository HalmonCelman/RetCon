...
for(i = 0; i < KS0108_SCREEN_WIDTH/64; i++)
  {
  GLCD_WriteCommand(DISPLAY_SET_Y ,i);    //x ustawiony na obu kontrolerach na 0 pozycje
  GLCD_WriteCommand(DISPLAY_SET_X | y,i);//y ustawiony na 0 na obydwu
  GLCD_WriteCommand(DISPLAY_START_LINE ,i); //wyswietlana linia na 0
  }
